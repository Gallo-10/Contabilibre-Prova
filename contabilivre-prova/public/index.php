...
<body>
    <div class="container">
        ...
        <form method="POST" action="cliente.php" class="novo-cliente">
        ...
        <form method="POST" action="nota.php" class="nova-nota">
            <input type="hidden" name="acao" value="criar">
        ...
        <form method="GET" action="notas_cliente.php" class="notas-cliente">
            <select name="id_cliente" required>
                <option value="" disabled selected>Selecione o Cliente</option>
                <?php foreach ($clientes as $c): ?>
                    <option value="<?= $c['id']; ?>"><?= $c['nome']; ?></option>
